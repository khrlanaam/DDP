from hitung import *  
from modul_datar import *  
from modul_ruang import *  
...
def hitungan_aritmatika():
    ...
    print("4. Pembagian")
    print("5. Pangkat")
    pilihan = int(input("\nMasukkan operasi aritmatika yang ngin dipilih (1-5 ): "))
...
def hitungan_bangun_ruang():
    ...
    if pilihan == 1:
        ...
        r = float(input("Masukkan jari-jari bola: "))  # Input untuk jari-jari bola
        print("Luas Permukaan Bola:", round(luas_bola(r), 2))
